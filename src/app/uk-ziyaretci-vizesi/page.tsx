...
export const metadata = pageMetadata("İngiltere Ziyaretçi Vizesi", "İngiltere ziyaretçi vizesi için başvuru danışmanlığı.", "/uk-ziyaretci-vizesi");

export default function VisitorVisaPage() {
  return (
    <ServicePage
      slug="/uk-ziyaretci-vizesi"
      title="İngiltere Ziyaretçi Vizesi"
